...
/* Console log for global variables */
console.log(acresComplete);
console.log(cropsComplete);
console.log(monthsComplete);
console.log(fuelComplete);
...
var acresBox= document.forms[0].acres;
var acresBox = document.getElementById("acres").value;
...
function verifyAcres () {
	...
	if (! (acresBox.value> 0)) {
		...
		messageHeadElement.innderHTML = ""; // remove an former recommendation heading
